...
unsigned int nStakeMinAge = 7 * 24 * nOneHour; // 7 days as zero time weight
...
const string strMessageMagic = "StationCoin Signed Message:\n";
...
{
    int64_t nRewardCoinYear = 60 * CENT;
...
void ThreadScriptCheck(void*) {
    ...
    RenameThread("StationCoin-scriptch");
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in StationCoin
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (fProofOfStake)
    {
        ...
        // StationCoin: check proof-of-stake block signature
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "StationCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "station genesis block";
        CTransaction txNew;
        txNew.nTime = 1519677929;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1519677929;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 3586216; // !fTestNet ? 1575379 : 46534;
...
unsigned char pchMessageStart[4] = { 0xbd, 0xf8, 0xe2, 0xe5 };
