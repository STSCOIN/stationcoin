...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("STS");
    case mBTC: return QString("mSTS");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("StationCoins"));
    case mBTC: return QString(QObject::tr("Milli-StationCoins (1 / 1,000)"));
    default: return QString("???");
    }
}
